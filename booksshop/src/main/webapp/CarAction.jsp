...
<body>
	...
	<div id="from">
		<form action="chaxun">
			<input type="text" name="bookname"
				style="height: 40px; width: 500px; border: 2px #FF2D2D solid; margin-top: -50px">
			<input type="image" src="images/sousuo.jpg" height="40px"
				 style="margin-top: -3.7%; margin-left: 500px"> <br>
			<font color="#8E8E8E" size="2px" style="margin-top: 10px">热搜:</font>&nbsp;&nbsp;
			<a href="chaxun?bookname=单词" style="font-size: 15px; color: #8E8E8E">单词</a>&nbsp;&nbsp;&nbsp;
			<a href="chaxun?bookname=青春" style="font-size: 15px; color: #8E8E8E">
				青春 </a>&nbsp;&nbsp;&nbsp; <a href="chaxun?bookname=信心"
				style="font-size: 15px; color: #8E8E8E"> 信心 </a>&nbsp;&nbsp;&nbsp; <a
				href="chaxun?bookname=英语" style="font-size: 15px; color: #8E8E8E">英语</a>&nbsp;&nbsp;&nbsp;
			<a href="chaxun?bookname=java"
				style="font-size: 15px; color: #8E8E8E">java</a>&nbsp;&nbsp;&nbsp; <a
				href="chaxun?bookname=Hadoop"
				style="font-size: 15px; color: #8E8E8E">Hadoop</a>
		</form>
		<table cellpadding="20" style="margin-left: -5%; margin-top: 1.5%">
			<tr>
	...
	<hr width="100%" style="color: red; margin-top: -1%">
	<br>
	<br>

	<form action="dingdan.jsp" method="post">
		<table width=78% height=20px align="center"
			style="border-collapse: collapse; border: 0px solid #adadad;">
		...
		<table width=80% height=20px align="center"
			...
			<s:bean name="com.dao.impl.Books">
				<s:iterator value="#application.booklist1">
					<tr style="background-color: #ffecf5; border: 7px solid #FFFFFF;">
						<td align="center" width="400"><img
							src="<s:property value="pictire"/>" width="80px" height="100px" /></td>
						<td style="border:; border-collapse: collapse;"><s:property
								value="name" /></td>
						<td><s:property value="booknumber" /></td>
						<td><s:property value="bookprice" /></td>
						<td><s:property value="bookprice" />*<s:property
								value="booknumber" /></td>
						<td><a href="shopcardelete?bookid=<s:property value="id"/>"
							style="color: red; font-size: 15">删除</a></td>
					</tr>
					<br>
				</s:iterator>
			</s:bean>
	...
	<div id="foot">
		...
		|<a rel="nofollow" target="_blank"
			...
			target="_blank">青苑社区</a> |<a href="//gongyi.jd.com" target="_blank">青苑公益</a>
		<hr width="950" align="center">
		<br> <a>网络文化经营许可证：0266-989 | 互联网违法和不良信息举报电话：0897-29920</a>
	</div>
</body>
</html>
